<script>
	import { AURA_BASE_URL } from '$lib/constants';
	import { AURA_NAME, config, user, showSidebar } from '$lib/stores';
						...
						<td class="px-3 py-1 font-medium text-gray-900 dark:text-white w-max">
							<div class="flex flex-row w-max">
								<img
									...
									src={user.profile_image_url.startsWith(AURA_BASE_URL) ||
									user.profile_image_url.startsWith('https://www.gravatar.com/avatar/') ||
									user.profile_image_url.startsWith('data:')
										? user.profile_image_url
										: `${AURA_BASE_URL}/user.png`}
									alt="user"
								/>
...
> 
> AurA IDE is proudly open source and completely free, with no hidden limits — and we'd love to keep it that way. 🌱  
>
...
> 
> - 👉 **[Click here to learn more about enterprise licensing](https://docs.aura.com/enterprise)**
