...
from open_aura.models.channels import Channels
from open_aura.models.chats import Chats
from open_aura.models.notes import Notes, NoteUpdateForm
from open_aura.utils.redis import (
...
from open_aura.utils.auth import decode_token
from open_aura.socket.utils import RedisDict, RedisLock, YdocManager
from open_aura.tasks import create_task, stop_item_tasks
...
YDOC_MANAGER = YdocManager(
    redis=REDIS,
    redis_key_prefix="aura:ydoc:documents",
)
