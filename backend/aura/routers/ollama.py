...
from open_aura.utils.payload import (
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                ...
                headers={
                    ...
                    **(
                        {
                            "X-AurA-User-Name": quote(user.name, safe=" "),
                            "X-AurA-User-Id": user.id,
                            "X-AurA-User-Email": user.email,
                            "X-AurA-User-Role": user.role,
                        }
...
async def send_post_request(
    ...
    try:
        ...
        if r.ok is False:
            try:
                ...
                raise HTTPException(
                    ...
                    detail=f"AurA IDE: Server Connection Error",
                )
        ...
        raise HTTPException(
            ...
            detail=detail if e else "AurA IDE: Server Connection Error",
        )
...
async def verify_connection(
    ...
    async with aiohttp.ClientSession(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail="AurA IDE: Server Connection Error"
            )
        except Exception as e:
    ...
    if url_idx is None:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "AurA IDE: Server Connection Error",
            )
...
async def get_openai_models(
    ...
    if url_idx is None:
        ...
        try:
            ...
            log.exception(e)
            error_detail = "AurA IDE: Server Connection Error"
            if r is not None:
                try:
                    res = r.json()
                    if "error" in res:
