from aura.utils.task import prompt_template, prompt_variables_template
from aura.utils.misc import (
    deep_update,
...
def remove_aura_params(params: dict) -> dict:
    """
    Removes Aura specific parameters from the provided dictionary.
    """
    aura_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_open_aura_params(params)
