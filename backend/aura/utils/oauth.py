...
from open_aura.models.auths import Auths
from open_aura.models.users import Users
from open_aura.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from open_aura.utils.misc import parse_duration
from open_aura.utils.auth import get_password_hash, create_token
from open_aura.utils.webhook import post_webhook

from open_aura.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in AurA: {[g.name for g in all_available_groups]}"
        )
    ...
    async def handle_callback(self, request, provider, response):
        ...
        redirect_base_url = str(request.app.state.config.AURA_URL or request.base_url)
