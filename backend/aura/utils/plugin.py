...
from open_aura.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from open_aura.models.functions import Functions
from open_aura.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from open_aura.utils",
        "from apps": "from open_aura.apps",
        "from main": "from open_aura.main",
        "from config": "from open_aura.config",
    }
